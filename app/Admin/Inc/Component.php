...
final class Component {
    ...
    public static function get_logo() {
        return sprintf(
            ...
            __( 'Handy Added To Cart Toaster Notifier', 'handy-added-to-cart-toaster-notifier' ),
            __( 'Handy Added To Cart Toaster Notifier', 'handy-added-to-cart-toaster-notifier' )
        );
    }
     ...
     * @since 1.0.0
     *
     * @param  array $args  Contains the all arguments for creating tab component.
     * $args = [
     ...
     * @since 1.0.0
     *
     * @param  array $args Contains the all arguments for creating tab panel component.
     * $args = [
