...
final class FieldValidation {
     ...
     *     'current_value' => (string) The current value from _hatfw_main_settings.
     * ]
     * @return array
     */
     ...
     *     'current_value' => (int) The current value from _hatfw_main_settings.
     * ]
     * @return array
     */
     ...
     *     'current_value' => (boolean) The current value from _hatfw_main_settings.
     * ]
     * @return array
     */
     ...
     *     'current_value' => (int|string) The current value from _hatfw_main_settings.
     * ]
     * @return array
     */
