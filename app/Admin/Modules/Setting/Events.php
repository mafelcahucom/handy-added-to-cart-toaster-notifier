...
final class Events {
    ...
    protected function __construct() {
         ...
         * Save settings.
         */
        add_action( 'wp_ajax_hatfw_save_settings', array( $this, 'save_settings' ) );
    }
    ...
    public function save_settings() {
        ...
        $current_settings_value = get_option( '_hatfw_main_settings' );
        if ( empty( $current_settings_value ) ) {
            // Get the default values of fields if _hatfw_main_settings is emty.
        ...
        // Update option field _hatfw_main_settings.
        if ( count( $validation['validation']['valid'] ) > 0 ) {
            update_option( '_hatfw_main_settings', $validation['updated_value'] );
        }
