            ...
            <div class="hd-home__banner">
                <div class="hd-txt-center">
                    <p class="hd-home__developer">
                        <span><?php echo __( 'HANDCRAFTED BY ', 'handy-added-to-cart-toaster-notifier' ); ?></span>
                        <a href="#" target="_blank">
                            <?php echo __( 'MAFEL JOHN CAHUCOM', 'handy-added-to-cart-toaster-notifier' ); ?>
                        </a>
                    </p>
                    <h1 class="hd-home__title">
                        <?php echo __( 'Handy Tools', 'handy-added-to-cart-toaster-notifier' ); ?>
                    </h1>
                    <p class="hd-home__description">
                        <?php echo __( 'Handy Tools offers a suite of free, easy-to-use WordPress plugins crafted to streamline the development and management of your WooCommerce stores.', 'handy-added-to-cart-toaster-notifier' ); ?>
                    </p>
                </div>
            </div>
                    ...
                    <div class="hd-home-plugin">
                                    ...
                                    <div class="hd-home-col__right">
                                        ...
                                        <?php if ( Plugins::is_installed( $plugin['slug'] ) ) : ?>
                                            <p class="hd-home-plugin__status" data-state="installed">
                                                ...
                                                <?php echo __( 'Installed', 'handy-added-to-cart-toaster-notifier' ); ?>
                                            </p>
                                        <?php else : ?>
                                            <p class="hd-home-plugin__status" data-state="not-installed">
                                                ...
                                                <?php echo __( 'Not Installed', 'handy-added-to-cart-toaster-notifier' ); ?>
                                            </p>
                                        <?php endif; ?>
                                    </div>
                                </div>
                        ...
                        <div class="hd-home-plugin__footer">
                            <div class="hd-home-plugin__tools">
                                <a class="hd-home-plugin__tool" href="https://wordpress.org/download/" target="_blank" aria-label="<?php echo __( 'WordPress', 'handy-added-to-cart-toaster-notifier' ); ?>" title="<?php echo __( 'WordPress', 'handy-added-to-cart-toaster-notifier' ); ?>">
                                    ...
                                    <span>
                                        <?php echo __( '4.8.14+', 'handy-added-to-cart-toaster-notifier' ); ?>
                                    </span>
                                </a>
                                <a class="hd-home-plugin__tool" href="https://woocommerce.com/" target="_blank" aria-label="<?php echo __( 'WooCommerce', 'handy-added-to-cart-toaster-notifier' ); ?>" title="<?php echo __( 'WooCommerce', 'handy-added-to-cart-toaster-notifier' ); ?>">
                                    ...
                                    <span>
                                        <?php echo __( '4.0.0+', 'handy-added-to-cart-toaster-notifier' ); ?>
                                    </span>
                                </a>
                                <a class="hd-home-plugin__tool" href="https://www.php.net/" target="_blank" aria-label="<?php echo __( 'PHP', 'handy-added-to-cart-toaster-notifier' ); ?>" title="<?php echo __( 'PHP', 'handy-added-to-cart-toaster-notifier' ); ?>">
                                    ...
                                    <span>
                                        <?php echo __( '7.4.8+', 'handy-added-to-cart-toaster-notifier' ); ?>
                                    </span>
                                </a>
                            </div>
                                ...
                                <?php if ( Plugins::is_installed( $plugin['slug'] ) ) : ?>
                                    <?php if ( Plugins::is_active( $plugin['slug'] ) ) : ?>
                                        <a class="hd-btn" href="<?php echo esc_url( admin_url( 'admin.php?page=' . $plugin['prefix'] ) ); ?>">
                                            <?php echo __( 'Dashboard', 'handy-added-to-cart-toaster-notifier' ); ?>
                                        </a>
                                    <?php else : ?>
                                        <a class="hd-btn" href="<?php echo esc_url( admin_url( 'plugins.php' ) ); ?>">
                                            <?php echo __( 'Activate', 'handy-added-to-cart-toaster-notifier' ); ?>
                                        </a>
                                    <?php endif; ?>
                                <?php else : ?>
                                    <a class="hd-btn" href="<?php echo esc_url( $plugin['download'] ); ?>" target="_blank">
                                        <?php echo __( 'Download', 'handy-added-to-cart-toaster-notifier' ); ?>
                                    </a>
                                <?php endif; ?>
                            </div>
                        </div>
